...
happens to strength under a cut or taper. **Human-reviewed** (2026-07-28):
this file is agent-authored per `00-conventions.md`'s workflow; Andrew has
reviewed it and it is treated as settled grounding truth.
...
**Human-reviewed.** Hibberd et al. (2012), Manske et al. (2015), and Tavares,
